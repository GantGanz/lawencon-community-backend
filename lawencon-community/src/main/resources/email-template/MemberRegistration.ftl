                            ...
                            <tbody>
                                <tr>
                                    <td align="center"
                                        ...
                                        <img style="display: none" /><img src="./assets/logo.png" style="width: 60px"
                                ...
                                <tr>
                                    <td align="center" style="padding: 5px 40px 5px 40px">
                                        <img src="./assets/email-icon.png" width="125" height="120"
                                ...
                                <tr>
                                    <td align="center" style="padding: 0px 150px 10px 150px">
                                        <p style="text-align: center; font-size: 30px;  border-radius: 5px;">
                                            <b style="color: #002242;">${code}</b>
                                        </p>
